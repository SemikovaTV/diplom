...
5. Ссылка на тестовое приложение - [testapp](http://89.169.169.85:31122/) и веб интерфейс Grafana с данными доступа - [grafana](http://51.250.14.233:30382) login - admin, passwd - prom-operator.
